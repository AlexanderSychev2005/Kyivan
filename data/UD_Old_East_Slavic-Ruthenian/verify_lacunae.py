...
with open('data/UD_Old_East_Slavic-Ruthenian/ruthenian_raw.json', 'r', encoding='utf-8') as f:
    raw_data = json.load(f)
with open('data/UD_Old_East_Slavic-Ruthenian/ruthenian_cleaned.json', 'r', encoding='utf-8') as f:
...
with open(r'C:\Users\Alex\.gemini\antigravity\brain\9090b4b2-56d0-4e84-b6dd-24958fdb5e8d\verification.md', 'w', encoding='utf-8') as f:
    f.write(md_content)
